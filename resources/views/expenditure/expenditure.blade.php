...
<div class="card">
	<div class="card-header">
        <div class="row">
            <div class="col-md-12">
                <h1 class="card-title">Expenditures - This page shows only current month's expenditures. For other months, search in the form above.</a></h1>
			...
			<tbody>
                ...
                <tr>
                    ...
                    @if ($expenditure->invoice)
                        <a href="{{ asset( 'storage/'.$expenditure->invoice) }}" class="btn btn-success" target="_blank">Invoice</a>
                        @else
                        No Invoice
                        @endif      
                    </td>
                   ...
                   <td>
                    <a href="{{ route('expenditure.updateShow',$expenditure->id ) }}" class="btn btn-secondary update" data-id="{{ $expenditure->id }}"><i class="fas fa-pen"></i></a>
