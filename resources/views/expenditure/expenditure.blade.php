...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="card-title">Expenditures - This page shows only current month's expenditures. For other
                        months, search in the form above.</a></h1>
                ...
                <tbody>
                    @foreach ($expenditures as $expenditure)
                        <tr>
                            ...
                            <td width="55%">{{ $expenditure->description }}</td>
                            <td>{{ $expenditure->category->name }}</td>
                            <td>{{ $expenditure->price }}</td>
                            <td>
                                @if ($expenditure->invoice)
                                    <a href="{{ asset('storage/' . $expenditure->invoice) }}" class="btn btn-success"
                            ...
                            <td>{{ $expenditure->invoice_date }}</td>

                            <td>
                                <a href="{{ route('expenditure.updateShow', $expenditure->id) }}"
                                    class="btn btn-secondary update" data-id="{{ $expenditure->id }}"><i
                                        class="fas fa-pen"></i></a>
                                <button type="button" class="btn btn-danger delete" data-id="{{ $expenditure->id }}"><i
